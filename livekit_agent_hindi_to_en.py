...
# Configuration
TARGET_PARTICIPANT = "amit"  # Change this to target a different participant
...
class EnglishTranslator(Agent):
    def __init__(self) -> None:
        super().__init__(
             instructions=(
                "YOU ARE A PROFESSIONAL HINDI TO ENGLISH TRANSLATOR. TRANSLATE THE USER'S SPEECH FROM HINDI TO ENGLISH."
                "DO NOT RESPOND TO QUESTIONS, JUST TRANSLATE THE QUESTION ITSELF"
                "ONLY TRANSLATE IF THE USER IS SPEAKING IN HINDI."
                "FOR NON HINDI SPEAKERS, STAY SILENT AND DO NOT RESPOND."
            ),
        )
