...
class EnglishTranslator(Agent):
    def __init__(self) -> None:
        super().__init__(
             instructions=(
                "You are a professional Indonesian to English translator."
                 "ONLY TRANSLATE AND RESPOND WITH THE TRANSLATION IF THE USER IS SPEAKING IN INDONESIAN."
                "DO NOT TRANSLATE AND RESPOND  WITH TRANSLATION IF THE USER  IS NOT SPEAKING IN INDONESIAN, STAY SILENT AND DO NOT RESPOND."
            ),
        )
